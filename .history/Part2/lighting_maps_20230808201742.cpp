...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("4.1.lighting.vs", "4.1.lighting.fs");
    Shader lightCubeShader("3.light_cube.vs", "3.light_cube.fs");
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)6);
    glEnableVertexAttribArray(0);
